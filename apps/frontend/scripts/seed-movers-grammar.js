...
async function main() {
  ...
  if (!fileName) {
    throw new Error('Please provide the JSON filename as an argument (e.g. node seed-movers-grammar.js movers-grammar-cum7.json)');
  }

  console.log(`--- START SEEDING MOVERS GRAMMAR & DIALOGUE: ${fileName} ---`);
